...
/* package GraphMBTP-0.1.0.0 */
#ifndef VERSION_GraphMBTP
#define VERSION_GraphMBTP "0.1.0.0"
#endif /* VERSION_GraphMBTP */
#ifndef MIN_VERSION_GraphMBTP
#define MIN_VERSION_GraphMBTP(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_GraphMBTP */
...
#define CURRENT_COMPONENT_ID "GraphMBTP-0.1.0.0-inplace-GraphMBT"
